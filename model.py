...
class CRCNN(nn.Module):
    def __init__(self, word_vec, class_num, config):
        ...
        """
            The convo-lutional layer first produces local features around
        ...
        """
            The fixed-sized distributed vector rep-
            resentation for the sentence is obtained by using
            the max over all word windows
        """
